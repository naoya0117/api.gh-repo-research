...
func (r *queryResolver) UnevaluatedRepositoriesWithDockerfile(ctx context.Context, limit *int32, offset *int32) ([]*model.Repository, error) {
	l := 50
	if limit != nil && *limit > 0 {
		l = int(*limit)
	}
...
func (r *queryResolver) SearchEvaluatedRepositories(_ context.Context, query string, limit *int32, offset *int32) ([]*model.Repository, error) {
	...
	repos, err := r.DB.SearchEvaluatedRepositories(query, l, o)
	if err != nil {
